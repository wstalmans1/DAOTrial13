...
echo "   Option A - Automatic deployment with Fleek (recommended):"
...
echo ""
echo "   Option B - Manual deployment with Fleek (alternative):"
echo "   Step 1: Push your code to GitHub"
echo "   - Make sure your code is committed: git add -A && git commit -m 'Ready to deploy'"
echo "   - Push to GitHub: git push origin main"
echo "   - Your code must be on GitHub for Fleek to deploy it"
echo ""
echo "   Step 2: Connect Fleek to your GitHub repository"
echo "   - Go to https://app.fleek.co and sign in (or create a free account)"
echo "   - Click 'Add New Site' or 'New Site'"
echo "   - Choose 'Connect GitHub' or 'Deploy from GitHub'"
echo "   - Authorize Fleek to access your GitHub account"
echo "   - Select your repository (DAOTrial13 or whatever you named it)"
echo "   - Select the 'main' branch (or your default branch)"
echo ""
echo "   Step 3: Configure environment variables (secrets)"
echo "   - Before deploying, you need to add your environment variables"
echo "   - In Fleek, go to your site settings → 'Environment Variables' or 'Secrets'"
echo "   - Add these variables (get values from your apps/dao-dapp/.env.local file):"
echo "     * VITE_WALLETCONNECT_ID (get one free from https://cloud.walletconnect.com)"
echo "     * VITE_MAINNET_RPC (or use default: https://cloudflare-eth.com)"
echo "     * VITE_POLYGON_RPC (or use default: https://polygon-rpc.com)"
echo "     * VITE_OPTIMISM_RPC (or use default: https://optimism.publicnode.com)"
echo "     * VITE_ARBITRUM_RPC (or use default: https://arbitrum.publicnode.com)"
echo "     * VITE_SEPOLIA_RPC (or use default: https://rpc.sepolia.org)"
echo "   - Click 'Save' after adding each variable"
echo ""
echo "   Step 4: Configure build settings"
echo "   - Go back to 'Build Settings' or 'Build Configuration' section"
echo "   - In the 'Build Command' field, enter: pnpm web:build"
echo "   - In the 'Publish Directory' or 'Output Directory' field, enter: apps/dao-dapp/dist"
echo "   - (If you don't see these fields, look for 'Advanced Settings' or 'Show More Options')"
echo "   - Click 'Deploy Site' or 'Deploy' button at the bottom"
echo ""
echo "   Step 5: Wait for deployment"
echo "   - Fleek will build your app and deploy it to IPFS"
echo "   - You'll get a URL like: your-site.on.fleek.co"
