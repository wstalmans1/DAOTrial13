...
echo ""
echo "   Step 3: Set up Fleek for automatic deployment (recommended)"
echo "   - Go to https://app.fleek.co and sign in (or create a free account)"
echo "   - Click 'Add New Site' or 'New Site' button"
echo "   - Choose 'Connect GitHub' or 'Deploy from GitHub'"
echo "   - Authorize Fleek to access your GitHub account (click 'Authorize')"
echo "   - Select your repository from the list"
echo "   - Select the 'main' branch (or your default branch name)"
echo ""
echo "   Step 4: Configure build settings in Fleek"
echo "   - After selecting your repo, you'll see a configuration page"
echo "   - Look for 'Build Settings' or 'Build Configuration' section"
...
echo ""
echo "   Step 5: Add environment variables in Fleek"
echo "   - In the same Fleek configuration page, find 'Environment Variables' or 'Secrets' section"
echo "   - Click 'Add Variable' or '+' button"
...
echo ""
echo "   Step 6: Deploy manually (first time)"
...
echo ""
echo "   Step 7: Set up automatic deployment via GitHub Actions (optional but recommended)"
