...
echo "     * 'Build Command': Enter pnpm web:build"
echo "     * 'Publish Directory': Enter apps/dao-dapp/dist"
echo "   - (These fields are right below the branch selection - you'll see them on the same page)"
echo ""
echo "   Step 4: Add environment variables in Fleek"
...
echo ""
echo "   Step 5: Deploy manually (first time)"
...
echo ""
echo "   Step 6: Set up automatic deployment via GitHub Actions (optional but recommended)"
